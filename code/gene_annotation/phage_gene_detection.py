...
def save_phage_information(genebase, phage_name, dir_path):
    ...
    genebase.to_csv(os.path.join(phage_dir, f"{phage_name}_genebase.csv"), index=False)

    protein_fasta_path = os.path.join(phage_dir, f"{phage_name}_proteins.fasta")
    gene_fasta_path = os.path.join(phage_dir, f"{phage_name}_genes.fasta")

    write_protein_fasta(genebase, protein_fasta_path)
    write_gene_fasta(genebase, gene_fasta_path)
